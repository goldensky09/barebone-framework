...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/base2/start.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Bootstrapper; });
...
var Bootstrapper = /*#__PURE__*/function () {
  ...
  _createClass(Bootstrapper, [{
    ...
    value: function initComponents() {
      document.querySelectorAll("[data-class-def]").forEach(function (cmp, idx, cmpNodeList) {
        var classDef = cmp.getAttribute("data-class-def").split(".");
...
/***/ "./src/base2/core/BaseComponent/index.js":
/*!***********************************************!*\
  !*** ./src/base2/core/BaseComponent/index.js ***!
  \***********************************************/
/*! exports provided: default */
...
var BaseComponent = /*#__PURE__*/function () {
  function BaseComponent(cmpNode) {
  ...
  _createClass(BaseComponent, [{
    ...
    value: function addHandler() {
      ...
      this.cmpNode.addEventListener("click", function (e) {
        console.log("clicked on" + JSON.stringify(_this.cmpNode.dataset));
      });
    }
  }, {
    key: "subscribe",
...
var _require = __webpack_require__(/*! ./lib/constants */ "./src/base2/core/Store/lib/constants.js"),
    TARGET = _require.TARGET,
    UNSUBSCRIBE = _require.UNSUBSCRIBE;

var path = __webpack_require__(/*! ./lib/path */ "./src/base2/core/Store/lib/path.js");

var isArray = __webpack_require__(/*! ./lib/is-array */ "./src/base2/core/Store/lib/is-array.js");

var isSymbol = __webpack_require__(/*! ./lib/is-symbol */ "./src/base2/core/Store/lib/is-symbol.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Watch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Watch */ "./src/base2/core/Store/Watch.js");
/* harmony import */ var _Watch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_Watch__WEBPACK_IMPORTED_MODULE_0__);
...
var subscriptions = {};
var obj = {
  watch: function watch(propPath, callback) {
    ...
    if (Object(lodash__WEBPACK_IMPORTED_MODULE_1__["get"])(this, propPath)) {
      callback(Object(lodash__WEBPACK_IMPORTED_MODULE_1__["get"])(this, propPath), undefined, this);
    }
...
var i = 0;
var Store = _Watch__WEBPACK_IMPORTED_MODULE_0___default()(obj, function (path, value, previousValue) {
  var _this = this;
  ...
  subscriptions[path] && subscriptions[path].forEach(function (callback) {
    callback(value, previousValue, _this);
  });
}); // const handler = {
...
/***/ "./src/base2/core/Store/lib/constants.js":
/*!***********************************************!*\
  !*** ./src/base2/core/Store/lib/constants.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/base2/core/Store/lib/is-array.js":
/*!**********************************************!*\
  !*** ./src/base2/core/Store/lib/is-array.js ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./src/base2/core/Store/lib/is-symbol.js":
/*!***********************************************!*\
  !*** ./src/base2/core/Store/lib/is-symbol.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/base2/core/Store/lib/path.js":
/*!******************************************!*\
  !*** ./src/base2/core/Store/lib/path.js ***!
  \******************************************/
/*! no static exports found */
...
var _require = __webpack_require__(/*! ./constants */ "./src/base2/core/Store/lib/constants.js"),
    PATH_SEPARATOR = _require.PATH_SEPARATOR;

var isArray = __webpack_require__(/*! ./is-array */ "./src/base2/core/Store/lib/is-array.js");

var isSymbol = __webpack_require__(/*! ./is-symbol */ "./src/base2/core/Store/lib/is-symbol.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bootstrapper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bootstrapper */ "./src/base2/bootstrapper.js");
/* harmony import */ var _core_BaseComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./core/BaseComponent */ "./src/base2/core/BaseComponent/index.js");
/* harmony import */ var _core_Store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./core/Store */ "./src/base2/core/Store/index.js");
...
NS.Components.BaseComponent = _core_BaseComponent__WEBPACK_IMPORTED_MODULE_1__["default"];
document.addEventListener("DOMContentLoaded", function () {
  NS.Store = _core_Store__WEBPACK_IMPORTED_MODULE_2__["default"];
  new _bootstrapper__WEBPACK_IMPORTED_MODULE_0__["default"]();
});
window.NS = NS;
